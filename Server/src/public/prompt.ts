...
export const getQuestionPrompt = (): string => {
...
**Important Note:** The clues should never include the name of the city or any direct references that make it obvious. The hints should be descriptive but not reveal the city name in any way.
